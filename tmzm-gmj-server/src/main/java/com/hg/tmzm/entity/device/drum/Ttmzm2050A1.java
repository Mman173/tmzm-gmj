...
@TableName("TTMZM2050A1")
public class Ttmzm2050A1 extends BaseEntity {
    ...
    @TableField("PRE_ROTATING_DRUM_NO")
    private String preRotatingDrumNo;

    @TableField("ROLLER_NO_TR")
    private String rollerNoTr;

    @TableField("PRE_ROLLER_NO_TR")
    private String preRollerNoTr;
    ...
    @TableField("BEARING_SMALL")
    private String bearingSmall;

    @TableField("BEARING_BIG")
    private String bearingBig;

    @TableField("HOUSING_SMALL")
    private String housingSmall;

    @TableField("HOUSING_BIG")
    private String housingBig;
