...
@TableName("TTMZM2032B")
public class Ttmzm2032b extends BaseEntity {
    ...
    // Additional fields for Ttmzm2032b
    @TableField("PROC_AI_SIZE")
    private String procAiSize;

    @TableField("PROC_BI_SIZE")
    private String procBiSize;

    @TableField("PRACTICAL_GROOVE_BI_SIZE")
    private String practicalGrooveBiSize;

    @TableField("ROLL_DIAMETER_DEVIATION")
    private String rollDiameterDeviation;

    @TableField("BZ_SC_ZS")
    private String bzScZs;
    ...
    @TableField("JGQ_GROOVE_FORM_NO")
    private String jgqGrooveFormNo;
